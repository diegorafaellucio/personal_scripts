...
processed_output_dataset_path = '/home/diego/2TB/arn_processed_3_classes'

if not os.path.exists(processed_output_dataset_path):
    os.mkdir(processed_output_dataset_path)
else:
    shutil.rmtree(processed_output_dataset_path)
    os.mkdir(processed_output_dataset_path)
    ...
    for evaluation_day_subset in evaluation_day_subsets:
        ...
        if evaluation_day_subset in WHITE_LIST:
            ...
            for evaluation_day_subset_image in tqdm.tqdm(evaluation_day_subset_images):
                ...
                gt_output_path = os.path.join(processed_output_dataset_path, str(gt_index))
                ...
                predicted_output_path = os.path.join(gt_output_path, str(predicted_index))

                if not os.path.exists(predicted_output_path):
                    os.mkdir(predicted_output_path)

                output_image_path = os.path.join(predicted_output_path, str(evaluation_day_subset_image))
                # print(evaluation_day_subset_image_path, output_image_path)
                shutil.copy(evaluation_day_subset_image_path, output_image_path)
