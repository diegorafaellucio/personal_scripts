...
subset_blacklist = ['INCLASSIFICAVEL', 'DATA', 'BANDA_A_ANGULADA', 'BANDA_B_ANGULADA', 'ANNOTATIONS', 'ANNOTATIONS_JSON']
        ...
        for subset in subsets:
            if subset not in subset_blacklist:
                ...
                if os.path.exists(person_images_path):
                    subset_images = [os.path.join(person_images_path,file) for file in os.listdir(person_images_path) if 'jpg' in file or 'png' in file]
...
generateDatabaseFromMultiplePaths(['/home/diego/2TB/datasets/ECOTRACE/GCP/eco/bovinos/3-MEAT/TRAIN/ECOTRACE/BARRA_MANSA/BM/4.0', '/home/diego/2TB/datasets/ECOTRACE/GCP/eco/bovinos/3-MEAT/TRAIN/ECOTRACE/FRIGOL/LP/1.0'], '/home/diego/2TB/TREINOS/BARRAMANSA_4.0+LP_1.0/DATA')
