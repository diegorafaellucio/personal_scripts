...
def main():
    ...
    parser.add_argument('--model', type=str, default='/home/diego/Projects/PERSONAL/scripts/modules/label_studio/label_studio/2-generate-preannotation-to-project-pytroch-obb.py', help='Path to OBB Ultralytics model')
    parser.add_argument('--output', type=str, default='/home/diego/obb_track_betterbeef', help='Directory to save output frames')
